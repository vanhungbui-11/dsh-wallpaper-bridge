...
assert(!captureRoute.includes('new URL('), '捕获路由不得依赖 Cordis 动态沙箱未提供的 URL 全局对象')
assert(captureRoute.includes("match(/(?:^|&)window=([^&]*)/)") && captureRoute.includes("'-title', windowName"), '捕获路由必须把请求窗口名原样交给捕获工具')
